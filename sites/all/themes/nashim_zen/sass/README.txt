...
the FireCompass plug-in into Firefox and then edit your sub-theme's config.rb
file to set: firecompass = true
  https://addons.mozilla.org/en-US/firefox/addon/firecompass-for-firebug/
